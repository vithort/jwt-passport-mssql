require('dotenv').config({
    path: process.env.NODE_ENV === "pro" ? ".env" : ".env.dev"
});
...
const sequelize = new Sequelize(process.env.mssqlDbname, process.env.mssqlUser, process.env.mssqlPwd, {
    dialect: 'mssql'
